...
<head>
    ...
    <style>
        ...
        .thank-you-badge { background: rgba(255,255,255,0.25); color: #ffffff; padding: 8px 16px; border-radius: 20px; display: inline-block; margin-top: 15px; font-size: 14px; font-weight: bold; border: 1px solid rgba(255,255,255,0.3); }
...
<head>
    ...
    <style>
        ...
        .header p { margin: 10px 0 0 0; opacity: 0.95; color: #f8fafc; font-weight: 500; }
