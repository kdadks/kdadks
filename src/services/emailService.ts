...
<head>
    ...
    <style>
        ...
        .thank-you-badge { background: rgba(255,255,255,0.2); color: white; padding: 8px 16px; border-radius: 20px; display: inline-block; margin-top: 15px; font-size: 14px; font-weight: bold; }
        ...
        .detail-value { color: #16a34a; font-weight: bold; }
